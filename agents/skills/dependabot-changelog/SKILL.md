...
description: >-
  Fetch real release notes and changelogs for Dependabot PRs and post them as a
  structured PR comment. Use this skill whenever Dependabot opens a PR (or group
  PR) with dependency updates and the changelog is missing, empty, or unhelpful —
  especially when the user says things like "write the changelog", "Dependabot
  failed to publish the changelog", "post the release notes", "what changed in
  this PR", or "look at this Dependabot PR". Also trigger when the user shares a
  Dependabot PR URL and asks you to summarize or annotate it. This skill handles
  all package ecosystems: Composer/PHP, npm/JS, pip/Python, etc.
---
